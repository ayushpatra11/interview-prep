 ...
 * to get to the intersected node. skipB - The number of nodes to skip ahead in
 * listB (starting from the head) to get to the intersected node. The judge will
 * then create the linked structure based on these inputs and pass the two
 * heads, headA and headB to your program. If you correctly return the
 ...
 * point to the same location in memory. Example 2:
 *
